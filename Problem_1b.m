...
%% itis basically the same operation as the 6 elements probability but we are using 36 probabilities
%% the 36 probabilities
clc;
clear;
...
Prob_new=Prob_new';
I=zeros(1,length(Prob_new)); % Information Array of 6 elements
P=Prob_new; % Probabilities array 

H=0;
%% Information values
for i=1:length(Prob_new)
...
Huffman_Tree= zeros(36,35);           % Creating the Huffman Tree
...
fprintf('\n by matlab check --> Efficiency2 = %f \n',Efficiency2);
 ...
 %%  i noticed a little bit difference between the efficiency of my code and the
 %% built in matlab function , maybe it's something with the rounding!